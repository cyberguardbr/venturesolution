...
acl CONNECT method CONNECT POST OPTIONS GET TRACE HEAD PUT DELETE PATCH PROPATCH
...
visible_hostname VentureSolution
...
echo '# Openvpn Configuration by VentureSolution Brazil :)
dev tun
port 53
proto udp
topology subnet
...
{
  clear
  echo "OPENVPN SERVER VentureSolution"
